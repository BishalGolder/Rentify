...
/*
    ...
    Only safe for reads that DON'T depend on auth.uid()
    (e.g. public verified-property listing/search).
    Never use this for inserts/updates/deletes that RLS scopes to a specific user.
*/
